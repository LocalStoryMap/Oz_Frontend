...
function CratePostIcon({
  ...
  return (
    ...
    >
      <rect width="24" height="24" fill="url(#pattern0_57_1419)" />
      <defs>
        <pattern
          id="pattern0_57_1419"
          ...
          height="1"
        >
          <use xlinkHref="#image0_57_1419" transform="scale(0.0111111)" />
        </pattern>
        <image
          id="image0_57_1419"
          width="90"
